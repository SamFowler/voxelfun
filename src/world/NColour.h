...
{
public:
    NColour() : r(0x00), g(0x00), b(0x00), a(0x00) {};
    NColour(int r_in, int g_in, int b_in, int a_in )
    {
        setColours(r_in, g_in, b_in, a_in);
    };

    bool operator==(const NColour& other) const 
    {
...
struct ColourHash 
{
    size_t operator()(const NColour& colour) const
    { 
